...
struct
  ...
  module Compress = struct
    ...
    let value_t : value Irmin.Type.t =
      ...
      |~ case1 "contents-ii" (pair int int63) (fun (n, i) ->
             Contents (Indirect n, Indirect i, T.default))
      |~ case1 "contents-x-ii" (triple int int63 metadata_t) (fun (n, i, m) ->
             Contents (Indirect n, Indirect i, m))
      |~ case1 "node-ii" (pair int int63) (fun (n, i) ->
      ...
      |~ case1 "contents-di" (pair step_t int63) (fun (n, i) ->
             Contents (Direct n, Indirect i, T.default))
      |~ case1 "contents-x-di" (triple step_t int63 metadata_t)
           (fun (n, i, m) -> Contents (Direct n, Indirect i, m))
      |~ case1 "node-di" (pair step_t int63) (fun (n, i) ->
